 ...
 * ProductFormModal — identical fields either way, only the submit
 * call differs. */
export default function SupplierFormModal({
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    try {
      ...
      setError("Could not save this supplier. Please check the values and try again.");
    } finally {
    ...
    >
      <form id="supplier-form" onSubmit={handleSubmit} className="space-y-4">
        ...
        <Input
          ...
          placeholder="Shop location or delivery address"
        />
